...
model_save_dir = os.path.join(BASE_DIR, "models", "rotation_est_value_8cls"+str(NUM_POINT))
...
def writeToFileOne(epoch):
    fl = open(os.path.join(log_save_dir, "rotation_value_8cls_"+str(NUM_POINT)+".txt"),'a+')
    if epoch == 0:
